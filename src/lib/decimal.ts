 ...
 */
function toBigInt(value: number | string | Decimal): bigint {
...
export class Decimal {
  ...
  constructor(value: number | string | Decimal | bigint) {
    if (value instanceof Decimal) {
  ...
  static _fromRaw(raw: bigint): Decimal {
  ...
  percent(rate: Decimal | number | string): Decimal {
  ...
  clampMin(floor: Decimal | number | string): Decimal {
